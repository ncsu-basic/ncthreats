#!/usr/local/pythonenvs/tilecacacheenv/bin/python
...
if __name__ == '__main__':
    ...
    parser.add_option(
        ...
        dest="port", action='store', type="int", default=5010
        )
    parser.add_option(
        "-t", "--threading", help="threading http server. default is false",
        dest="threading", action='store_true', default=False
        )
